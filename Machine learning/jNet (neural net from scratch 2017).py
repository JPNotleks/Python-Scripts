#This is a neural network from scratch, which I implemented in 2017 by deriving the backpropagation equations with the chain rule.
#It is fully functional and capable of learning with SGD. It can plot a graphical representation of the network as it trains
#(in my plotting library piGraph), and could easily be modified to perform dropout or other regularisation methods.
