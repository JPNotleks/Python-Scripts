#A 3D extension of my piGraph plotter. This script was capable of plotting the Mandelbrot orbits (not the asymptotic object!)
#on a 3D grid, which yields haunting illustrations of the Mandelbrot's complexity without just plotting the final object.
