#Implements a fast Fourier transform from first principles.
#The core idea is that the DFT matrix satisfies a symmetry/recursion which allows one to intertwine Fourier transforms
#of half the size iteratively. This yields a tremendous speedup from quadratic (n^2) to pseudolinear (n*log(n)), which makes Fourier
#transforms viable in the first place.
